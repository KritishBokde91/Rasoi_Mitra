...
class _BookingHistoryScreenState extends State<BookingHistoryScreen>
  ...
  Future<List<Map<String, dynamic>>> _fetchBookings(String? status) async {
    try {
  ...
  BookingItem _mapToBookingItem(Map<String, dynamic> data) {
    try {
      ...
      debugPrint('Error mapping booking item: $e');
      return BookingItem(
        id: 'Error',
        mealType: 'Unknown',
        item: 'Error Item',
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    ...
                    Tab(
                      child: FutureBuilder<List<Map<String, dynamic>>>(
                        future: _fetchBookings('Confirmed'),
                        builder: (context, snapshot) {
                          return Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
  ...
  Widget _buildBookingsList(
    ...
    return FutureBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  'Error loading bookings: ${snapshot.error.toString().split(':').last.trim()}',
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      _refreshKeys[tabIndex] =
                          GlobalKey(); // Reset key to force refetch
                    });
                  },
        ...
        final bookings =
            snapshot.data?.map((data) => _mapToBookingItem(data)).toList() ??
            [];
        if (bookings.isEmpty) {
          return Container(
        ...
        return CustomRefreshIndicator(
          onRefresh: () async {
            ...
            await _fetchBookings(status); // Ensure data is refetched
          },
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text(
                                                '${booking.quantity} ${booking.isCustom ? 'people' : 'qty'}',
                                                style: TextStyle(
                                                  fontSize: 14,
                                                  color: Colors.grey[600],
                                                  fontWeight: FontWeight.w500,
